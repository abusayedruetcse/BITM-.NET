...
namespace StockManagementSystem
{
    public partial class HistoryUi : Form
    {
        ...
        {
            dataTable = _historyManagement.LoadCategoryCompanyItemHistory("Categories");
            display();
        }

        private void companySetupLabel_Click(object sender, EventArgs e)
        {
            dataTable = _historyManagement.LoadCategoryCompanyItemHistory("Companies");
            display();
        }

        private void itemSetupLabel_Click(object sender, EventArgs e)
        {
            dataTable = _historyManagement.LoadCategoryCompanyItemHistory("Items");
            display();
        }

        private void stockInLabel_Click(object sender, EventArgs e)
        {
            dataTable = _historyManagement.LoadStockInOutHistory("StockIns");
            display();
        }

        private void stockOutLabel_Click(object sender, EventArgs e)
        {
            dataTable = _historyManagement.LoadStockInOutHistory("StockOuts");
            display();
        } 
